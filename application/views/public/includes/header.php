...
<head>
	...
	<script src="https://cloud.tinymce.com/5/tinymce.min.js?apiKey=2uqil06ybxtcw7l0yhyqb11k4pqeyci8mmwmdtoet5jkbs4a"></script>
	<script>tinymce.init({selector: '.tinymce', height: 350});</script>
