...
<body>
    ...
    <div class="content">
        <h1>Employers</h1>
        <a href="<?php echo site_url('admin/employers/add'); ?>" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Add Employer</a>
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo site_url('admin/employers/edit/'.$employer->id); ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
                        <a href="<?php echo site_url('admin/employers/delete/'.$employer->id); ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
